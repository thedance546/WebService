  ...
  return (
    <GlobalBackground>
      ...
      <div className="d-grid gap-3" style={{ width: '85%', maxWidth: '400px', margin: '0 auto' }}>
        <Button onClick={() => navigate('/Register')} className="btn-lg w-100" variant="success">회원가입</Button>
        <Button onClick={() => navigate('/Login')} className="btn-lg w-100" variant="primary">로그인</Button>
        <Button onClick={() => navigate('/food/my-Ingredients')} className="btn-lg w-100" variant="secondary">로그인 없이 시작</Button>
      </div>
    </GlobalBackground>
