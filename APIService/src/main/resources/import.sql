...
INSERT INTO items (item_name, category_id, storage_method_id, shelf_life_id) VALUES ('사과', (SELECT category_id FROM categories WHERE category_name = '과일'), (SELECT storage_method_id FROM storage_methods WHERE storage_method_name = '냉장'), (SELECT shelf_life_id FROM shelf_lifes WHERE sell_by_days = 14 AND use_by_days = 21));
INSERT INTO items (item_name, category_id, storage_method_id, shelf_life_id) VALUES ('비엔나 소세지', (SELECT category_id FROM categories WHERE category_name = '가공식품'), (SELECT storage_method_id FROM storage_methods WHERE storage_method_name = '냉장'), (SELECT shelf_life_id FROM shelf_lifes WHERE sell_by_days = 14 AND use_by_days = 21));
